...
const staffMembers: StaffMember[] = [
  {
    ...
    role: 'MightyMC Owner',
    roleType: 'owner',
    description: 'Founder and visionary behind MightyMC. Oversees all server operations and community growth.',
  ...
  },
  {
    ...
    role: 'dev',
    roleType: 'developer',
    description: 'Developer and management lead with expertise in overseeing projects, resolving player disputes, and enforcing community rules.',
  ...
  },
  {
    ...
    name: 'Max',
    role: 'Moderator',
    roleType: 'Discord moderator',
    description: 'Dedicated Discord Moderator focused on supporting new members and ensuring positive, respectful community interactions.',
    ...
    helpedPlayers: 2200,
    quote: 'Every new player deserves support — feel free to ask anything!'
  },
  {
    id: 5,
    name: 'DevMaster',
