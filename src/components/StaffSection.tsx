...
const staffMembers: StaffMember[] = [
  ...
  },
  {
    ...
    avatar: 'https://mc-heads.net/avatar/IIXEP9/128',
    joinDate: '2018-09-10',
    experience: 5,
    ...
    helpedPlayers: 2800,
    quote: 'Every new player deserves a warm welcome! Please feel free to message me anytime, Im available on Discord 24/7, with a typical response time of under 1 hour'
  },
  {
    id: 4,
    name: 'Cudlin',
